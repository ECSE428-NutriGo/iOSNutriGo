...
- (void) layout {
    ...
    [signIn addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(login)]];
    [self.view addSubview:signIn];
}

- (void)login {
    NSString *post = [NSString stringWithFormat:@"username=%@&password=%@&email=%@", emailField.text, pwdField.text, emailField.text];
